        ...
        <v-carousel-item v-for="(item, i) in items" :key="i" :src="item.src">
          <v-container fill-height fluid ma-0 pa-0>
            <v-card class="transparent card_mgleft" outlined xs12 sm6 offset-sm3>
              <v-list-item>
                <v-list-item-content>
                  <div class="overline mb-10 font-weight-bold" style="text-shadow: 1px 1px 4px rgba(0,0,0,0.25);">{{ item.caption }}</div>
                  <v-list-item-title
  ...
  data: () => ({
    items: [
      ...
      },
      {
        ...
        desc: 'Organic Quinoa & Bazra Mixed. No Chemicals. <br> Qaulity and healthy. Increasing Family & Education Time. '
      },
      {
